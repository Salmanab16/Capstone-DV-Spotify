     ...
     tabItems(
       ...
       tabItem(tabName = "User_Profile", 
               fluidPage(
                 ...
                 br(),
                 div(style = "text-align:justify",
                     p("This project is made by Salma Nabilah Rouf as her Capstone Project for completing Data Visualization Specialist in Algoritma Data Science School. You can connect me through ", 
                       tags$a(href="https://www.linkedin.com/in/salma-nabilah-rouf-7734b0148/", "linkedin"), 
